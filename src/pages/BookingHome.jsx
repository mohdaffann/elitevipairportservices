...
function BookingHome() {
    ...
    return (
        <div className="min-h-screen py-10 px-4 bg-none">
            <h1 className="text-4xl font-bold text-center mt-10 mb-8 capitalize text-white">{airport.replace(/-/g, " ")} Booking</h1>
